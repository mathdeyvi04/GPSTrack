...
private:
    ...
    converter_graus_para_nmea(
        ...
        int graus  = (int) std::floor(valor_abs);
     ...
     * @param corpo_da_frase Frase sem os indicadores $ e *   
     * @return String contendo a frase completa NMEA, com todas as informações e flags. 
     */
    static std::string 
    formar_nmea(
...
public:
    ...
    /**
     * @brief Configura a trajetória estática para simulação.    
     */
    void 
    config_traj(){
